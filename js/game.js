...
$(document).ready(function(){
    ...
    $('.turntable').click(function(){
    	...
    	disable = 1;
    	// 防止連按
    	$('.turntable').removeClass('for-hover');
    ...
    $('.right').click(function(){
    	...
    	$('.turntable img:nth-of-type(1)').attr('src','img/turntable.png');
...
function roll(){
	$('.turntable img:nth-of-type(1)').attr('src','img/turntable_'+tempCounter+'.png');
	tempCounter++;
...
function drawDestiny(){
	...
	// $('.to-pick-card').click(function(){
 //    	$(this).toggleClass('card-flipped');
 //    	$(this).toggleClass('already-flipped');
 //    });
